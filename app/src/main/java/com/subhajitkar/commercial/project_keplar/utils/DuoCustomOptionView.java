...
public class DuoCustomOptionView extends DuoOptionView {
    ...
    public DuoCustomOptionView(Context context) {
        this(context, null);
    }

    public DuoCustomOptionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DuoCustomOptionView(Context context, AttributeSet attrs, int defStyleAttr) {
